...
public class InitialSetupMigration {
    ...
    public void addUsers(MongoTemplate mongoTemplate) {
        ...
        anonymousUser.setId("user-anonymoususer");
        ...
        IntStream.range(1, MAX).forEach(index -> {
            User user = new User();
            user.setId("user-" + index);
            user.setLogin("user" + index);
            user.setPassword(encoder.encode(user.getLogin()));
            user.setFirstName(index + "");
            user.setLastName("User");
            user.setEmail("user" + index + "@localhost");
            user.setActivated(true);
            user.setLangKey("en");
            user.setCreatedBy(systemUser.getLogin());
